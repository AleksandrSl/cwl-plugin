...
class ToFromOriginalFileMapper private constructor(
        val originalFile: CwlFile,
        val syntheticFile: CwlFile,
        val completionOffset: Int
) {
    companion object {
        fun create(parameters: CompletionParameters): ToFromOriginalFileMapper {
            val originalFile = parameters.originalFile as CwlFile
            val syntheticFile = parameters.position.containingFile as CwlFile
