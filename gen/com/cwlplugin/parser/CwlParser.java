...
public class CwlParser implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // IDENTIFIER COLON INDENT command_input_parameter_field + DEDENT
  static boolean command_input_parameter(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "command_input_parameter")) return false;
    if (!nextTokenIs(b, IDENTIFIER)) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeTokens(b, 0, IDENTIFIER, COLON, INDENT);
    r = r && command_input_parameter_3(b, l + 1);
  ...
  private static boolean command_input_parameter_3(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "command_input_parameter_3")) return false;
    boolean r;
    Marker m = enter_section_(b);
    ...
    while (r) {
      ...
      if (!empty_element_parsed_guard_(b, "command_input_parameter_3", c)) break;
      c = current_position_(b);
    }
    exit_section_(b, m, null, r);
    return r;
  ...
  /* ********************************************************** */
  // COLON INDENT command_output_binding_field + DEDENT
  public static boolean command_output_binding(PsiBuilder b, int l) {
    ...
    r = r && command_output_binding_2(b, l + 1);
    r = r && consumeToken(b, DEDENT);
  ...
  private static boolean command_output_binding_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "command_output_binding_2")) return false;
    boolean r;
    Marker m = enter_section_(b);
    ...
    while (r) {
      ...
      if (!empty_element_parsed_guard_(b, "command_output_binding_2", c)) break;
      c = current_position_(b);
    }
    exit_section_(b, m, null, r);
    return r;
  ...
  /* ********************************************************** */
  // IDENTIFIER COLON INDENT command_output_parameter_field + DEDENT
  public static boolean command_output_parameter(PsiBuilder b, int l) {
    ...
    Marker m = enter_section_(b);
    r = consumeTokens(b, 0, IDENTIFIER, COLON, INDENT);
    r = r && command_output_parameter_3(b, l + 1);
    r = r && consumeToken(b, DEDENT);
  ...
  private static boolean command_output_parameter_3(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "command_output_parameter_3")) return false;
    boolean r;
    Marker m = enter_section_(b);
    ...
    while (r) {
      ...
      if (!empty_element_parsed_guard_(b, "command_output_parameter_3", c)) break;
      c = current_position_(b);
    }
    exit_section_(b, m, null, r);
    return r;
  ...
  /* ********************************************************** */
  // CLASS COLON DIRECTORY_TYPE INDENT directory_field + DEDENT
  public static boolean directory(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "directory")) return false;
    if (!nextTokenIs(b, CLASS)) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeTokens(b, 0, CLASS, COLON, DIRECTORY_TYPE, INDENT);
    r = r && directory_4(b, l + 1);
    r = r && consumeToken(b, DEDENT);
  ...
  // directory_field +
  private static boolean directory_4(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "directory_4")) return false;
    boolean r;
    Marker m = enter_section_(b);
    ...
    while (r) {
      ...
      if (!empty_element_parsed_guard_(b, "directory_4", c)) break;
      c = current_position_(b);
    }
    exit_section_(b, m, null, r);
    return r;
  ...
  /* ********************************************************** */
  // CLASS COLON DOCKER_REQUIREMENT INDENT docker_requirement_field + DEDENT
  static boolean docker_requirement(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "docker_requirement")) return false;
    if (!nextTokenIs(b, CLASS)) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeTokens(b, 0, CLASS, COLON, DOCKER_REQUIREMENT, INDENT);
    r = r && docker_requirement_4(b, l + 1);
    r = r && consumeToken(b, DEDENT);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  private static boolean docker_requirement_4(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "docker_requirement_4")) return false;
    boolean r;
    Marker m = enter_section_(b);
    ...
    while (r) {
      ...
      if (!empty_element_parsed_guard_(b, "docker_requirement_4", c)) break;
      c = current_position_(b);
    }
    exit_section_(b, m, null, r);
    return r;
  ...
  /* ********************************************************** */
  // CLASS COLON ENV_VAR_REQUIREMENT INDENT env_def DEDENT
  static boolean env_var_requirement(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "env_var_requirement")) return false;
    if (!nextTokenIs(b, CLASS)) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeTokens(b, 0, CLASS, COLON, ENV_VAR_REQUIREMENT, INDENT);
    r = r && env_def(b, l + 1);
    r = r && consumeToken(b, DEDENT);
    exit_section_(b, m, null, r);
    return r;
  ...
  /* ********************************************************** */
  // CLASS COLON FILE_TYPE INDENT file_field + DEDENT
  public static boolean file(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "file")) return false;
    if (!nextTokenIs(b, CLASS)) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeTokens(b, 0, CLASS, COLON, FILE_TYPE, INDENT);
    r = r && file_4(b, l + 1);
    r = r && consumeToken(b, DEDENT);
  ...
  /* ********************************************************** */
  // CLASS COLON INITIAL_WORKDIR_REQUIREMENT INDENT initial_workdir_listing DEDENT
  static boolean initial_workdir_requirement(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b);
    r = consumeTokens(b, 0, CLASS, COLON, INITIAL_WORKDIR_REQUIREMENT, INDENT);
  ...
  /* ********************************************************** */
  // INPUT_BINDING COLON INDENT command_line_binding_field + DEDENT
  static boolean input_binding(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b);
    r = consumeTokens(b, 0, INPUT_BINDING, COLON, INDENT);
    r = r && input_binding_3(b, l + 1);
    r = r && consumeToken(b, DEDENT);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  private static boolean input_binding_3(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "input_binding_3")) return false;
    boolean r;
    Marker m = enter_section_(b);
    ...
    while (r) {
      ...
      if (!empty_element_parsed_guard_(b, "input_binding_3", c)) break;
      c = current_position_(b);
    }
    exit_section_(b, m, null, r);
    return r;
  ...
  /* ********************************************************** */
  // INPUTS COLON INDENT command_input_parameter + DEDENT
  static boolean inputs(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "inputs")) return false;
    if (!nextTokenIs(b, INPUTS)) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeTokens(b, 0, INPUTS, COLON, INDENT);
    r = r && inputs_3(b, l + 1);
    r = r && consumeToken(b, DEDENT);
    exit_section_(b, m, null, r);
    return r;
  ...
  private static boolean inputs_3(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "inputs_3")) return false;
    boolean r;
    Marker m = enter_section_(b);
    ...
    while (r) {
      ...
      if (!empty_element_parsed_guard_(b, "inputs_3", c)) break;
      c = current_position_(b);
    }
    exit_section_(b, m, null, r);
    return r;
  ...
  /* ********************************************************** */
  // OUTPUTS COLON INDENT command_output_parameter + DEDENT
  static boolean outputs(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b);
    r = consumeTokens(b, 0, OUTPUTS, COLON, INDENT);
    r = r && outputs_3(b, l + 1);
    r = r && consumeToken(b, DEDENT);
    exit_section_(b, m, null, r);
    return r;
  ...
  private static boolean outputs_3(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "outputs_3")) return false;
    boolean r;
    Marker m = enter_section_(b);
    ...
    while (r) {
      ...
      if (!empty_element_parsed_guard_(b, "outputs_3", c)) break;
      c = current_position_(b);
    }
    exit_section_(b, m, null, r);
    return r;
  ...
  /* ********************************************************** */
  // REQUIREMENTS COLON INDENT requirement + DEDENT
  static boolean requirements(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "requirements")) return false;
    if (!nextTokenIs(b, REQUIREMENTS)) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeTokens(b, 0, REQUIREMENTS, COLON, INDENT);
    r = r && requirements_3(b, l + 1);
    r = r && consumeToken(b, DEDENT);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // requirement +
  private static boolean requirements_3(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "requirements_3")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = requirement(b, l + 1);
    int c = current_position_(b);
    while (r) {
      ...
      if (!empty_element_parsed_guard_(b, "requirements_3", c)) break;
      c = current_position_(b);
    }
    exit_section_(b, m, null, r);
    return r;
  ...
  /* ********************************************************** */
  // CLASS COLON RESOURCE_REQUIREMENT INDENT resource_requirement_field * DEDENT
  static boolean resource_requirement(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "resource_requirement")) return false;
    if (!nextTokenIs(b, CLASS)) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeTokens(b, 0, CLASS, COLON, RESOURCE_REQUIREMENT, INDENT);
    r = r && resource_requirement_4(b, l + 1);
    r = r && consumeToken(b, DEDENT);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  private static boolean resource_requirement_4(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "resource_requirement_4")) return false;
    int c = current_position_(b);
    while (true) {
      if (!resource_requirement_field(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "resource_requirement_4", c)) break;
      c = current_position_(b);
    }
    return true;
  }
  ...
  /* ********************************************************** */
  // SECONDARY_FILES COLON INDENT (STRING | EXPRESSION | string_array | expression_array) DEDENT
  static boolean secondary_files(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "secondary_files")) return false;
    if (!nextTokenIs(b, SECONDARY_FILES)) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeTokens(b, 0, SECONDARY_FILES, COLON, INDENT);
    r = r && secondary_files_3(b, l + 1);
    r = r && consumeToken(b, DEDENT);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  private static boolean secondary_files_3(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "secondary_files_3")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, STRING);
    if (!r) r = consumeToken(b, EXPRESSION);
  ...
  /* ********************************************************** */
  // CLASS COLON SOFTWARE_REQUIREMENT INDENT packages DEDENT
  static boolean software_requirement(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "software_requirement")) return false;
    if (!nextTokenIs(b, CLASS)) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeTokens(b, 0, CLASS, COLON, SOFTWARE_REQUIREMENT, INDENT);
    r = r && packages(b, l + 1);
    r = r && consumeToken(b, DEDENT);
    exit_section_(b, m, null, r);
    return r;
