...
public class CwlInitialWorkdirListingImpl extends ASTWrapperPsiElement implements CwlInitialWorkdirListing {

  public CwlInitialWorkdirListingImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CwlVisitor visitor) {
    visitor.visitInitialWorkdirListing(this);
  }
  ...
  @Override
  @Nullable
  public CwlDirentArray getDirentArray() {
    return findChildByClass(CwlDirentArray.class);
  }
