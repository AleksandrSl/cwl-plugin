...
public class CwlResourceRequirementImpl extends ASTWrapperPsiElement implements CwlResourceRequirement {

  public CwlResourceRequirementImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CwlVisitor visitor) {
    visitor.visitResourceRequirement(this);
  }
