...
public class CwlSecondaryFilesImpl extends ASTWrapperPsiElement implements CwlSecondaryFiles {

  public CwlSecondaryFilesImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CwlVisitor visitor) {
    visitor.visitSecondaryFiles(this);
  }
  ...
  public PsiElement getSecondaryFilesTk() {
    return findNotNullChildByType(SECONDARY_FILES_TK);
  }
