...
public class CwlTemporaryFailCodesImpl extends ASTWrapperPsiElement implements CwlTemporaryFailCodes {

  public CwlTemporaryFailCodesImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CwlVisitor visitor) {
    visitor.visitTemporaryFailCodes(this);
  }
