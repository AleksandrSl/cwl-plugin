...
public class CwlSoftwarePackageArrayImpl extends ASTWrapperPsiElement implements CwlSoftwarePackageArray {

  public CwlSoftwarePackageArrayImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CwlVisitor visitor) {
    visitor.visitSoftwarePackageArray(this);
  }
  ...
  @Override
  @NotNull
  public List<CwlSoftwarePackage> getSoftwarePackageList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CwlSoftwarePackage.class);
  }
