...
public class CwlArgumentsImpl extends ASTWrapperPsiElement implements CwlArguments {

  public CwlArgumentsImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<CwlInputBinding> getInputBindingList() {
