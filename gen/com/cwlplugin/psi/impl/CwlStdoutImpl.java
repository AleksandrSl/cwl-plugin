...
public class CwlStdoutImpl extends ASTWrapperPsiElement implements CwlStdout {

  public CwlStdoutImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CwlVisitor visitor) {
    visitor.visitStdout(this);
  }
  ...
  @Override
  @Nullable
  public PsiElement getStdoutTk() {
    return findChildByType(STDOUT_TK);
  }
