...
public class CwlCommandOutputParameterFieldImpl extends ASTWrapperPsiElement implements CwlCommandOutputParameterField {

  public CwlCommandOutputParameterFieldImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CwlVisitor visitor) {
    visitor.visitCommandOutputParameterField(this);
  }
