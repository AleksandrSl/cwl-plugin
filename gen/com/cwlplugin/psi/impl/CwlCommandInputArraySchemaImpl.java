...
public class CwlCommandInputArraySchemaImpl extends ASTWrapperPsiElement implements CwlCommandInputArraySchema {

  public CwlCommandInputArraySchemaImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CwlVisitor visitor) {
    visitor.visitCommandInputArraySchema(this);
  }
  ...
  @Override
  @Nullable
  public CwlCommandInputArrayItems getCommandInputArrayItems() {
    return findChildByClass(CwlCommandInputArrayItems.class);
  }
