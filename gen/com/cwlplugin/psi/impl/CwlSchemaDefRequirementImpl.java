...
public class CwlSchemaDefRequirementImpl extends ASTWrapperPsiElement implements CwlSchemaDefRequirement {

  public CwlSchemaDefRequirementImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CwlVisitor visitor) {
    visitor.visitSchemaDefRequirement(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getSchemaDefRequirementTk() {
    return findNotNullChildByType(SCHEMA_DEF_REQUIREMENT_TK);
  }
