...
public class CwlBaseCommandImpl extends ASTWrapperPsiElement implements CwlBaseCommand {

  public CwlBaseCommandImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CwlVisitor visitor) {
    visitor.visitBaseCommand(this);
  }
