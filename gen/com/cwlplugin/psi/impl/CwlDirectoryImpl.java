...
public class CwlDirectoryImpl extends ASTWrapperPsiElement implements CwlDirectory {

  public CwlDirectoryImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<CwlDirectoryField> getDirectoryFieldList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CwlDirectoryField.class);
  }
  ...
  public PsiElement getDirectoryTypeTk() {
    return findNotNullChildByType(DIRECTORY_TYPE_TK);
  }
