...
public class CwlDirentArrayImpl extends ASTWrapperPsiElement implements CwlDirentArray {

  public CwlDirentArrayImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CwlVisitor visitor) {
    visitor.visitDirentArray(this);
  }
  ...
  @Override
  @NotNull
  public List<CwlDirent> getDirentList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CwlDirent.class);
  }
