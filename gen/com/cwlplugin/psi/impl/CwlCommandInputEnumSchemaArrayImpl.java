...
public class CwlCommandInputEnumSchemaArrayImpl extends ASTWrapperPsiElement implements CwlCommandInputEnumSchemaArray {

  public CwlCommandInputEnumSchemaArrayImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CwlVisitor visitor) {
    visitor.visitCommandInputEnumSchemaArray(this);
  }
  ...
  @Override
  @NotNull
  public List<CwlCommandInputEnumSchema> getCommandInputEnumSchemaList() {
