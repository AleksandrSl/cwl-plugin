...
public class CwlCommandInputParameterImpl extends ASTWrapperPsiElement implements CwlCommandInputParameter {

  public CwlCommandInputParameterImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CwlVisitor visitor) {
    visitor.visitCommandInputParameter(this);
  }
  ...
  @Override
  @NotNull
  public List<CwlCommandInputParameterField> getCommandInputParameterFieldList() {
